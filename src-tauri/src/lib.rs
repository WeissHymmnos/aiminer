...
fn wait_for_backend() -> Result<(), String> {
    ...
    Err("backend sidecar did not listen on 127.0.0.1:8000 within 240s".to_string())
}
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            sidecar_command = sidecar_command
                ...
                .env(
                    "AIMINER_PACKAGED_MARKET_DATA_DIR",
                    market_data_dir.as_os_str(),
                )
