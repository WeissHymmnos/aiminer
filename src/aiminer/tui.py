...
from aiminer.core.strategy import StrategyConfig, strategy_templates
            ...
            with TabPane("Auto Miner (Swarm)", id="swarm-tab"):
                with Horizontal():
                    with VerticalScroll(classes="box", id="swarm-config"):
                        ...
                        default_roles = (
                            "Momentum expert focused on Hurst exponent and fractal dimension\n"
                            "Price-volume expert mining high-frequency volume-price correlation\n"
                            "Industry-neutral expert driven by macro cycle regime switches\n"
                            "Market-regime expert using hidden Markov state identification\n"
                            "ML expert focused on nonlinear factor synthesis and cross-validation\n"
                            "Order-book expert capturing micro trends via order-flow imbalance\n"
                            "Stat-arb expert using cointegration and error-correction models\n"
                            "Risk expert monitoring fat-tail return risk and dynamic hedges\n"
                            "Text-mining expert on earnings surprises and event-driven news\n"
                            "Graph expert mining industry-chain links via networks and knowledge graphs"
                        )
