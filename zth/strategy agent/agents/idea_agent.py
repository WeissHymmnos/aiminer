...
class IdeaAgent:
    ...
    It uses RAG to fetch factor-engine docs, Alpha/Academic Library, Market MetaData, and Past Experiences,
    ...
    def __call__(self, state: AlphaMinerState) -> Dict[str, Any]:
        ...
        mode = state.get("evaluation_mode", "ricequant")
        ...
        if not macro_context and mode == "ricequant":
             ...
             macro_context = self.rag.retrieve(macro_query, n_results=3, include_experiences=False)
