...
"""AI Alpha Miner — multi-agent swarm manager.

Copyright (C) 2026 AI Alpha Miner contributors
SPDX-License-Identifier: AGPL-3.0-only
"""
...
class PortfolioManager:
    """Orchestrates a swarm of SubAgents, pools factors, and orthogonalizes them."""
